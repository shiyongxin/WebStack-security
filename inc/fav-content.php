...
function fav_con($mid) { ?>
        <h4 class="text-gray" style="display: inline-block;"><i class="icon-io-tag" style="margin-right: 27px;" id="term-<?php echo absint($mid->term_id); ?>"></i><?php echo esc_html($mid->name); ?></h4>
        <?php 
