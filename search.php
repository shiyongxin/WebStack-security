...
<a href="<?php echo home_url('/'); ?>" style="position:absolute;margin:30px 0 0 30px;z-index:1000;"><img src="<?php echo io_get_option('logo_normal'); ?>" height="40" alt="<?php bloginfo('name'); ?>"></a>
<div class="main-content">
	...
	<div class="row">
		<div class="col-12 col-lg-8 mx-auto">
			<h4 class=”text-gray”><i class=”fa fa-search” style=”margin-right: 27px;”></i>”<?php echo get_search_query(); ?>” <?php _e('的搜索结果','i_theme'); ?></h4>
        	<div class="row">
