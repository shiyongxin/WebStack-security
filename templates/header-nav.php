                ...
                <header class="logo-env">
                    ...
                    <div class="logo">
                        <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-expanded">
                            <img src="<?php echo esc_url(io_get_option('logo_normal')); ?>" height="40" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" />
                        </a>
                        <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-collapsed">
                            <img src="<?php echo esc_url(io_get_option('logo_small')); ?>" height="40" alt="<?php echo esc_attr(get_bloginfo('name')); ?>">
                        </a>
                    </div>
